...
def build_input(cfg: Cfg) -> str:
    ...
    if cfg.hvac_vents:
        ...
        p(f"&SURF ID='vent_intake',  VEL=-{v_speed}, COLOR='GREEN', TMP_FRONT=20.0 /  ! supply (inflow, VEL<0)")
        p(f"&SURF ID='vent_exhaust', VEL={v_speed},  COLOR='BLUE' /  ! exhaust (outflow, VEL>0)")
